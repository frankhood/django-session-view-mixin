...
lint: ## check style with flake8
	flake8 session_view_mixin tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source session_view_mixin runtests.py tests
	coverage report -m
	coverage html
	open htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/django-session-view-mixin.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ session_view_mixin
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
